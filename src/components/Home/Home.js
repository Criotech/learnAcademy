    ...
    render() {
        return (
            <div className="container-fluid">
                ...
                {/* header section */}
                <header className="header" style={{ backgroundImage: `linear-gradient(to right bottom, rgba(20, 191, 150, 0.6), rgba(20, 191, 150, 0.6)), url(${Learn})` }}>
                    <div className="header__logo-box">
                        <h3 className="moveUp" style={{ color: "#fff", fontFamily: "cursive" }}>LearnAcademy</h3>
                    </div>
                    ...
                    <div className="header__text-box">
                        <h1 className="heading-primary">
                         ...
                         <DropdownButton id="dropdown-basic-button" size="lg" title="Discover more.">
                            <Dropdown.Item href="#/action-1"> Student Login</Dropdown.Item>
                            <Dropdown.Item href="#/action-2">Teacher Login</Dropdown.Item>
                        </DropdownButton>
                    </div>
                </header>
                ...
                <section className="teacher">
                    <Row>
                        ...
                        <Col lg={5} md={12}>
                            ...
                            <p class="teacherp2">We empower teachers to support their entire classroom. <br /> 90% of US teachers who have used Khan Academy have <br /> found us effective.</p>
                            <br />
