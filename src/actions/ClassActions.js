...
export const createClass = ({ className, classImage }) => {
    return (dispatch) => {
        ...
        axios.post("http://learnacademyapi.herokuapp.com/class/teacher", data)
            .then(res => {
...
export const fetchClassData = () => {
    return (dispatch) => {
        axios.get('http://learnacademyapi.herokuapp.com/class/teacher')
            .then((res) => {
...
export const deleteClass = (classId) => {
    return (dispatch) => {
        ...
        axios.delete(`http://learnacademyapi.herokuapp.com/class/teacher/${classId}`)
            .then(res => {
                dispatch(flashMessage({ message: res.data.message }))
                dispatch(fetchClassData())
            })
...
export const addStudent = ({ classId, studentMail }) => {
    return (dispatch) => {
        ...
        axios.post(`http://learnacademyapi.herokuapp.com/class/teacher/${classId}/addStudent`, { studentMail })
            .then(res => {
                dispatch(flashMessage({ message: res.data.message }))
            ...
            .catch(err => {
                // console.log(err)
                dispatch(flashMessage({ message: 'Account deos not exist' }))
            })
    }
}
...
export const getStudentsDetails = (classId) => {
    return (dispatch) => {
        axios.get(`http://learnacademyapi.herokuapp.com/class/teacher/members/${classId}`)
            .then(res => {
...
export const joinClass = (classId) => {
    return (dispatch) => {
        ...
        axios.post("http://learnacademyapi.herokuapp.com/class/student", { classId })
            .then(res => {
                dispatch(flashMessage({ message: res.data.message }))
...
export const fetchStudentClassData = () => {
    return (dispatch) => {
        axios.get('http://learnacademyapi.herokuapp.com/class/student')
            .then((res) => {
